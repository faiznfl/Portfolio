    ...
    <div class="max-w-7xl mx-auto space-y-8">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-slate-200 dark:border-white/10 pb-6">
            <div class="space-y-1">
                ...
                <p class="text-xs text-slate-500 dark:text-gray-400">Kelola daftar skill teknis, icon vektor SVG, dan penanda keahlian unggulan di portofolio.</p>
            </div>
            <div class="flex items-center gap-3">
                <a href="{{ route('admin.skills.create') }}" class="btn-ps-primary !py-2.5 !px-5 !text-xs !font-bold flex items-center gap-1.5 shadow-sm">
