                ...
                <div class="space-y-5">
                    ...
                    <div class="space-y-4 p-5 rounded-2xl bg-slate-50/80 dark:bg-white/[0.03] border border-slate-200 dark:border-white/10">
                        ...
                        <div class="pt-2 border-t border-slate-200 dark:border-white/10 flex flex-wrap items-center gap-2">
                            ...
                            <button type="button" onclick="selectProjectLocalPreset('/assets/projects/project-omnipulse.svg', 'OmniPulse Commerce')" class="px-2.5 py-1 rounded-lg text-xs bg-slate-200/70 dark:bg-white/10 hover:bg-ps-primary hover:text-white dark:hover:bg-cyan-400 dark:hover:text-black transition-colors font-mono">OmniPulse</button>
                            <button type="button" onclick="selectProjectLocalPreset('/assets/projects/project-hyperion.svg', 'Hyperion K8s')" class="px-2.5 py-1 rounded-lg text-xs bg-slate-200/70 dark:bg-white/10 hover:bg-ps-primary hover:text-white dark:hover:bg-cyan-400 dark:hover:text-black transition-colors font-mono">Hyperion</button>
                            <button type="button" onclick="selectProjectLocalPreset('/assets/projects/project-aethermesh.svg', 'AetherMesh Service')" class="px-2.5 py-1 rounded-lg text-xs bg-slate-200/70 dark:bg-white/10 hover:bg-ps-primary hover:text-white dark:hover:bg-cyan-400 dark:hover:text-black transition-colors font-mono">AetherMesh</button>
                            <button type="button" onclick="selectProjectLocalPreset('/assets/projects/project-nexus.svg', 'Nexus API Gateway')" class="px-2.5 py-1 rounded-lg text-xs bg-slate-200/70 dark:bg-white/10 hover:bg-ps-primary hover:text-white dark:hover:bg-cyan-400 dark:hover:text-black transition-colors font-mono">Nexus</button>
                            <button type="button" onclick="selectProjectLocalPreset('/assets/projects/project-sentinel.svg', 'Sentinel Security')" class="px-2.5 py-1 rounded-lg text-xs bg-slate-200/70 dark:bg-white/10 hover:bg-ps-primary hover:text-white dark:hover:bg-cyan-400 dark:hover:text-black transition-colors font-mono">Sentinel</button>
                            <button type="button" onclick="selectProjectLocalPreset('/assets/projects/project-collab.svg', 'Collab Platform')" class="px-2.5 py-1 rounded-lg text-xs bg-slate-200/70 dark:bg-white/10 hover:bg-ps-primary hover:text-white dark:hover:bg-cyan-400 dark:hover:text-black transition-colors font-mono">Collab</button>
                        </div>
                    </div>
                </div>
