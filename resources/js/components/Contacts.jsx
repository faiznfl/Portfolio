                    ...
                    <div className="lg:col-span-5 space-y-4">
                        ...
                        <div className="glass-panel p-5 sm:p-7 space-y-5 sm:space-y-6 shadow-sm dark:shadow-none">
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="flex items-center justify-between gap-3 p-3 rounded-2xl bg-slate-100/70 dark:bg-white/[0.02] border border-slate-200/80 dark:border-white/[0.06] hover:border-ps-primary dark:hover:border-blue-400/40 transition-all">
                                    <div className="flex items-center gap-3.5 min-w-0">
                                        <div className="w-11 h-11 rounded-2xl bg-slate-200/70 dark:bg-[#0d1527] border border-slate-300/80 dark:border-blue-500/30 flex items-center justify-center shrink-0 text-slate-700 dark:text-blue-400">
                                        ...
                                        <div className="min-w-0">
                                            ...
                                            <a
                                                href={`mailto:${email}`}
                                                className="text-sm sm:text-base font-semibold text-slate-900 dark:text-white hover:text-ps-primary dark:hover:text-blue-300 transition-colors truncate block"
                                ...
                                {/* Location Row */}
                                <div className="flex items-center gap-3.5 p-3 rounded-2xl bg-slate-100/70 dark:bg-white/[0.02] border border-slate-200/80 dark:border-white/[0.06] hover:border-ps-primary dark:hover:border-blue-400/40 transition-all">
                                    <div className="w-11 h-11 rounded-2xl bg-slate-200/70 dark:bg-[#0d1527] border border-slate-300/80 dark:border-blue-500/30 flex items-center justify-center shrink-0 text-slate-700 dark:text-blue-400">
                                        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="1.8">
                        ...
                        <form action={submitUrl || '/contact/submit'} method="POST" className="space-y-4 sm:space-y-5">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-5">
                                ...
                                <div className="space-y-1.5">
                                    <label htmlFor="sender_email" className="block text-xs font-mono uppercase tracking-wider text-slate-700 dark:text-gray-300 font-medium">
                                        Alamat Email <span className="text-ps-primary dark:text-blue-400">*</span>
                                    </label>
                                    <input
                                        type="email"
                                        id="sender_email"
                            ...
                            <div className="space-y-1.5">
                                <label htmlFor="subject" className="block text-xs font-mono uppercase tracking-wider text-slate-700 dark:text-gray-300 font-medium">
                                    Subjek Pesan <span className="text-ps-primary dark:text-blue-400">*</span>
                                </label>
                                <input
                                    type="text"
                                    id="subject"
                            ...
                            <div className="space-y-1.5">
                                <div className="flex items-center justify-between">
                                    <label htmlFor="message_body" className="block text-xs font-mono uppercase tracking-wider text-slate-700 dark:text-gray-300 font-medium">
                                        Isi Pesan <span className="text-ps-primary dark:text-blue-400">*</span>
                                    </label>
                            ...
                            <div className="pt-2">
                                <button
                                    type="submit"
                                    className="btn-ps-primary !w-full !py-3 !text-sm !font-bold !bg-blue-600 hover:!bg-blue-500 !shadow-lg !shadow-blue-600/30"
                                >
