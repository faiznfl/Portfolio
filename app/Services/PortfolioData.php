    ...
    public static function getCertificates(): Collection
    {
        $items = [
            [
                ...
                'course_name' => 'AWS Cloud Architecture & Infrastructure Specialization',
                ...
                'description' => 'Validasi keahlian komprehensif dalam mendesain infrastruktur cloud AWS yang memiliki ketersediaan tinggi (HA), fault-tolerant, hemat biaya, dan terdistribusi aman.',
                'order_index' => 1,
            ],
            [
                'id' => 2,
                'certificate_name' => 'HashiCorp Certified: Terraform Associate',
                'course_name' => 'Infrastructure as Code with Terraform & Multi-Cloud Automation',
                ...
                'description' => 'Sertifikasi kompetensi fundamental dan lanjutan Infrastructure as Code (IaC) untuk penyediaan dan pengelolaan resource multi-cloud secara deklaratif dan otomatis.',
                'order_index' => 2,
            ],
            [
                'id' => 3,
                'certificate_name' => 'Google Cloud Certified: Professional Cloud Developer',
                'course_name' => 'Developing Scalable Applications on Google Cloud Platform',
                ...
                'description' => 'Membangun aplikasi cloud-native yang terukur dan highly available menggunakan layanan komputasi, database terkelola, pub/sub streaming, dan orkestrasi Kubernetes Google Cloud.',
                'order_index' => 3,
            ],
            [
                'id' => 4,
                'certificate_name' => 'Sertifikasi Kompetensi Rekayasa Perangkat Lunak (Software Architect)',
                'course_name' => 'Pelatihan Nasional Standar Kompetensi Kerja Nasional Indonesia (SKKNI)',
                ...
                'description' => 'Sertifikasi profesi resmi negara Indonesia untuk standar perancangan arsitektur perangkat lunak skala enterprise, keamanan aplikasi, dan manajemen siklus hidup kode.',
                'order_index' => 4,
            ],
            [
                'id' => 5,
                'certificate_name' => 'ChatGPT & LLM Prompt Engineering for Developers',
                'course_name' => 'Advanced Prompt Engineering & LLM Architecture',
                'issuer_organization' => 'DeepLearning.AI',
                'issue_date' => '2024-03-10',
                'expiration_date' => '2027-03-10',
                'credential_id' => 'DLAI-PE-2024981',
                'credential_url' => 'https://learn.deeplearning.ai/certificates',
                'media_file_path' => '/assets/certificates/cert-aws-saa.svg',
                'category' => 'Prompt Engineering',
                'description' => 'Validasi keahlian dalam perancangan prompt tingkat lanjut, few-shot prompting, chain-of-thought, dan integrasi API LLM ke dalam aplikasi skala produksi.',
                'order_index' => 5,
            ],
            [
                'id' => 6,
                'certificate_name' => 'Artificial Intelligence Fundamentals & Applied Machine Learning',
                'course_name' => 'Core AI Concepts & Neural Networks Foundation',
                'issuer_organization' => 'IBM Developer Skills Network',
                'issue_date' => '2023-09-18',
                'expiration_date' => '2026-09-18',
                'credential_id' => 'IBM-AIB-441829',
                'credential_url' => 'https://skills.yourlearning.ibm.com/certificate',
                'media_file_path' => '/assets/certificates/cert-gcp.svg',
                'category' => 'Artificial Intelligence Basic',
                'description' => 'Sertifikasi pemahaman prinsip dasar kecerdasan buatan, model machine learning terawasi, evaluasi akurasi model, dan etika implementasi sistem AI.',
                'order_index' => 6,
            ],
        ];
